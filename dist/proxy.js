            ...
            const googleReq = https.request(parsedUrl, fwdOptions, (googleRes) => {
                ...
                googleRes.on('end', () => {
                    try {
                        ...
                        try {
                            const debugDir = path.join(electron_1.app.getPath('home'), '.gemini', 'antigravity');
                            fs.mkdirSync(debugDir, { recursive: true });
                            fs.writeFileSync(path.join(debugDir, 'debug_fetchAvailableModels.json'), JSON.stringify(googleJson, null, 2));
                        }
                        catch (e) {
